...
public class calculadora2 extends JFrame  implements ActionListener, calculadora2_interface
{
   ...
   public calculadora2()    //método construtor
   {
       setTitle("Calculadora do Neri Formulários com o Neri - INFORMATICON");
       ...
       lb_autor     = new JLabel("Neri Neitzke");
   ...
   public void actionPerformed(ActionEvent acao)
   {
       ...
       if (acao.getSource() == bt_somar)
           tf_resultado.setText(""+ calculo.format(obj_calculos.soma(num1, num2)));
       if (acao.getSource() == bt_multiplicar)
          tf_resultado.setText(""+ calculo.format(obj_calculos.multiplicacao(num1, num2)));
       if (acao.getSource() == bt_dividir)
          tf_resultado.setText(""+ calculo.format(obj_calculos.divisao(num1, num2)));
       if (acao.getSource() == bt_subtrair)
          tf_resultado.setText(""+ calculo.format(obj_calculos.subtracao(num1, num2)));
   ...
   public void converter()
   {
       try
       {
        ...
        {
            JOptionPane.showMessageDialog(null,"Digite um valor numérico válido "+erroNumber);

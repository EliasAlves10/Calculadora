...
public class calculadora1 extends JFrame  implements ActionListener, calculadora1_interface
{
   ...
   public calculadora1()    //método construtor
   {
   ...
   {
      JFrame obj_calc = new  calculadora1();
